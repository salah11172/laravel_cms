...
class RolesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $user1 = User::create(['name' => 'Salah Mostafa', 'username' => 'sami', 'email' => 'salah@bloggi.test', 'mobile' => '966500000003', 'email_verified_at' => Carbon::now(), 'password' => bcrypt('123123123'), 'status' => 1,]);
